...
public class MyBookingsFragment extends Fragment {
    ...
    private void doCancelBooking(@NonNull Booking booking) {
        FirebaseDatabase.getInstance().getReference("bookings")
                ...
                .addOnSuccessListener(unused -> {
                    ...
                    pushCancelNotification(booking);
    ...
    private void pushCancelNotification(@NonNull Booking booking) {
        String uid = FirebaseAuth.getInstance().getUid();
        if (uid == null) return;

        DatabaseReference root = FirebaseDatabase.getInstance().getReference();

        Hotel h = hotelCache.get(booking.hotelId);
        String hotelName = (h != null && h.name != null) ? h.name : "Hotel";
        String checkIn = df.format(new Date(booking.checkInMs));
        String checkOut = df.format(new Date(booking.checkOutMs));
        ...
        if (userNotifId != null) {
            ...
            payload.put("bookingId", booking.bookingId);
            payload.put("hotelId", booking.hotelId);
